  ...
  public:
    ...
    */
    ...
    /*!
      ...
      \param inBytes Ponter to array that will hold the read data.
    */
    ...
    */
    ...
    /*!
      ...
      \param data Ponter to array that holds the data that will be written.
    ...
    */
    ...
    /*!
      \brief Access method to get the number of interrupt/GPIO 0 pin.
      
      \returns Number of interrupt/GPIO 0 pin configured in the init method.
    */
    int getInt0() const { return(_int0); }
    
    /*!
      \brief Access method to get the number of interrupt/GPIO 1 pin.
      
      \returns Number of interrupt/GPIO 1 pin configured in the init method.
    */
