...
class SX1272: public SX127x {
  ...
  protected:
    uint8_t configCommon(float freq, uint8_t bw, uint8_t sf, uint8_t cr, uint8_t syncWord);   // common for SX1272/73
    
  private:
    uint8_t config(float freq, float bw, uint8_t sf, uint8_t cr, uint8_t syncWord);           // specific to SX1272
